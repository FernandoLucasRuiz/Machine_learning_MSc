...
1.  [crim:]{.underline} Tasa de criminalidad per cápita por ciudad.
2.  [zn]{.underline}: Proporción de terreno residencial zonificado para lotes de más de 25,000 pies cuadrados.
3.  [indus]{.underline}: Proporción de acres de negocio no minorista por ciudad.
4.  [chas]{.underline}: Variable ficticia Charles River (= 1 si el tramo limita con el río; 0 de lo contrario).
5.  [nox]{.underline}: Concentración de óxidos nítricos (partes por 10 millones).
6.  [rm]{.underline}: Número promedio de habitaciones por vivienda.
7.  [age]{.underline}: Proporción de unidades ocupadas por sus propietarios construidas antes de 1940.
8.  [dis]{.underline}: Distancias ponderadas a cinco centros de empleo de Boston.
9.  [rad]{.underline}: Índice de accesibilidad a autopistas radiales.
10. [tax]{.underline}: Tasa de impuesto a la propiedad de valor total por \$10,000.
11. [ptratio]{.underline}: Ratio alumno-profesor por ciudad.
12. [b]{.underline}: 1000(Bk - 0.63)/\^2 donde Bk es la proporción de personas negras por ciudad.
13. [lstat]{.underline}: Porcentaje de población de estatus bajo.
14. [medv]{.underline}: Valor mediano de las casas ocupadas por sus propietarios en miles de dólares.
...
1.  [Crim]{.underline}: Observamos que la tasa de criminalidad es baja aunque existen zonas en los datos que se llega a tasas muy altas de indice de criminalidad de hasta más de 80, que pueden ser los barrios problemáticos de la ciudad de Boston

2.  [Zn]{.underline}: Esta gráfica nos quiere decir que no hay muchas zonas residenciales, aunque hay dos picos intermedios sobre 23 y 80 que puede ser barrios residenciales.

3.  [Indus]{.underline}: Hay dos zonas de Boston con negocios de minoristas

4.  [Nox]{.underline}: La mayoria de zonas de Boston tienen una densidad de 0.4 y 0.6 ppm de oxido nitrico aunque hay otras menos que llegan hasta 0.9 ppm.

5.  [Rm]{.underline}: El número promedio de habitaciones en Boston son de aproximadamente 6 habitaciones por vivienda.

6.  [Age]{.underline}: Como vemos, la matoria de casas de Boston están construidas antes 1940. La cola a la izquierda nos puede sugerir que se están construyendo casas nuevas en Boston.

7.  [Dis]{.underline} : Esta gráfica nos indica que la mayoría de zonas se encuentran cerca de centros de empleo indicando que podría ser el centro de la ciudad, aunque la cola de la derecha nos indica que puede que los barrios residenciales se encuentren a las afueras de la ciudad.

8.  [Rad]{.underline}: Esta gráfica nos muestra que la mayoría de zonas se encuentran bien comunicadas con autopistas, pero hay una cierta densidad de zonas lejanas a autopistas por lo que podría indicar que son zonas residenciales o marginadas.

9.  [Tax]{.underline}: Esto nos indica que hay una distribución normal de las tasas excepto unas zonas que pagan más impuestos. Nos sugiere que puede ser una zona residencial de lujo.

10. [Ptratio]{.underline}: La mayoría se situa sobre 20 alumnos por profesor. La distribución se ensancha en la cola izquierda porque en colegios privados el ratio suele disminuir.

11. [B]{.underline}: Esta grádica nos puede sugerir que hay pocas zonas en la que la mayoría de personas son de raza caucásica.

12. [Lstat]{.underline}: La tasa de personas con estatus bajo ronda el 8% pero la cola de la derecha nos sugiere que hay zonas donde el porcentaje sube por lo que puede ser zonas marginales.

13. [Chas]{.underline}: La mayoría de zonas están alejadas del rio Charles
...
1.  [Crim]{.underline}: el precio de los barrios con mayor indice de crimininalidad es menor.
2.  [zn]{.underline}: Se aprecia una ligera relación positiva en esta variable
3.  indus: A mayor proporcion de negocios no minorista, el precio de la vivienda cae.
4.  [nox]{.underline}: Se ve una ligera tenendecia a que cuanto mayor es la cantidad de oxido nitrico menor es el precio de las viviendas. Es decir, las zonas más alejadas de la ciudad tendrán un valor mayor en el mercado.
5.  [rm]{.underline}: Se ve una clara correlación positiva entre el número de habitaciones y el precio de la vivienda.
6.  [age]{.underline}: Se intuye que en los barrios más modernos el precio es ligeramente superior al casco antiguo.
7.  [dis]{.underline}: Las zonas más alejadas de la ciudad parece ser que tienen los precios de viviendas más caros
8.  [rad]{.underline}: Parece ser que hay barrios con poca accesibilidad a la autopista y son aquellos con un precio más bajo. Hay algunos barrios donde el precio de la vivienda es muy alto y también tiene poca accesibilidad. Puede ser que sean zonas de residencia de lujo.
9.  [tax]{.underline}: Se ve una ligera correlacion negativa en esta variable.
10. [ptratio]{.underline}: Las zonas con las viviendas más caras tienen un ratio más bajo de alumno-profesorado.
11. [b]{.underline}: No se una relación clara
12. [lstat]{.underline}: Esta relación es bastante clara, ya que las personas con estatus bajo viven en zonas con el precio de la vivienda bajo
13. [chas]{.underline}: La descompesación de las clases no nos deja dar una conclusión aunque parece que las zonas cercanas al rio Charles aumentan el precio de la vivienda
...
1.  [x.box]{.underline}: La posición horizontal de la caja que encierra la letra (el rectángulo más pequeño que puede contener la imagen de la letra).

2.  [y.box]{.underline}: La posición vertical de la caja que encierra la letra.

3.  [width]{.underline}: El ancho de la caja en píxeles.

4.  [high]{.underline}: La altura de la caja en píxeles.

5.  [onpix]{.underline}: El total de píxeles encendidos (es decir, píxeles que contienen parte de la letra) en la imagen.

6.  [x.bar]{.underline}: La media de la posición horizontal de todos los píxeles encendidos.

7.  [y.bar]{.underline}: La media de la posición vertical de todos los píxeles encendidos.

8.  [x2bar]{.underline}: La varianza de la posición horizontal de todos los píxeles encendidos.

9.  [y2bar]{.underline}: La varianza de la posición vertical de todos los píxeles encendidos.

10. [xybar]{.underline}: La correlación entre la posición horizontal y vertical de los píxeles encendidos.

11. [x2ybr]{.underline}: La media del producto de x por la posición vertical de los píxeles encendidos.

12. [xy2br]{.underline}: La media del producto de y por la posición horizontal de los píxeles encendidos.

13. [x.ege]{.underline}: La cantidad de bordes horizontales (transiciones de claro a oscuro).

14. [xegvy]{.underline}: La correlación de x.ege con la variable y.

15. [y.ege]{.underline}: La cantidad de bordes verticales (transiciones de claro a oscuro).

16. [yegvx]{.underline}: La correlación de y.ege con la variable x.
...
1.  [Diabetes_binary]{.underline}: Variable objetivo binaria que indica si el paciente tiene diabetes (incluyendo prediabetes) o no.
2.  [HighBP]{.underline}: Presión arterial alta, indicada binariamente 0 = no 1 = si.
3.  [HighChol]{.underline}: Colesterol alto, también indicado de manera binaria 0 = no 1 = si.
4.  [CholCheck]{.underline}: Indica si el paciente ha tenido un chequeo de colesterol en los últimos 5 años 0 = no 1 = si.
5.  [BMI]{.underline}: Índice de masa corporal, medida cuantitativa.
6.  [Smoker]{.underline}: Indica si el paciente ha fumado al menos 100 cigarrillos en su vida 0 = no 1 = si.
7.  [Stroke]{.underline}: Indica si al paciente le han diagnosticado un derrame cerebral 0 = no 1 = si.
8.  [HeartDiseaseorAttack]{.underline}: Presencia de enfermedad coronaria o ataque cardíaco, indicado binariamente 0 = no 1 = si.
9.  [PhysActivity]{.underline}: Actividad física en los últimos 30 días, excluyendo el trabajo 0 = no 1 = si, indicado binariamente.
10. [Fruits]{.underline}: Consumo diario de frutas, indicado binariamente 0 = no 1 = si.
11. [Veggies]{.underline}: Consumo diario verduras, indicado binariamente 0 = no 1 = si.
12. [HvyAlcoholConsump]{.underline}: Consumo excesivo de alcohol 0 = no 1 = si.
13. [AnyHealthcare]{.underline}: Cobertura de salud de cualquier tipo 0 = no 1 = si.
14. [NoDocbcCost]{.underline}: Si hubo un momento en los últimos 12 meses en que el paciente necesitaba ver a un doctor pero no pudo debido al costo 0 = no 1 = si.
15. [GenHlth]{.underline}: Estado general de salud, medido en una escala de 1 a 5, 1 = excelente 2 = muy buena 3 = buena 4 = poca 5 = muy poca.
16. [MentHlth]{.underline}: Salud mental indicada por el número de días en los últimos 30 días que no fueron buenos.
17. [PhysHlth]{.underline}: Salud física indicada por el número de días en los últimos 30 días que no fueron buenos.
18. [DiffWalk]{.underline}: Dificultad para caminar o subir escaleras. 0 = no 1 = si.
19. [Sex]{.underline}: Género del paciente. 0 = mujer 1 = hombre
20. [Age]{.underline}: Edad, categorizada en 13 niveles de edad. 1 = 18-24, 9 = 60-64, 13 = 80 o mayores.
21. [Education]{.underline}: Nivel de educación, en una escala de 1 a 6, 1 = Nunca fue a la escuela, 2 = Grados 1 a 8 (Elemental), 3 = Grados 9 a 11 (Algo de instituto) 4 = Grados 12 or graduación (Graduado de instituto) 5 = Universidad de 1 a 3 años (Asistió a la universidad) 6 = Universidad 4 años o más (Graduado universitario).
22. [Income]{.underline}: Ingresos, categorizados en una escala de 1 a 8, 1 = menos de 10,000 USD, 5 = menos de 35,000 USD, 8 = 75,000 USD o mas.
...
-   [Accuracy]{.underline}: El 61.73% de todas las predicciones fueron correctas. Este valor indica la proporción general de predicciones correctas del modelo.

-   [Intervalo de Confianza del 95% para la Precisión]{.underline}: Entre 60.92% y 62.53%, lo que proporciona un rango estimado de precisión del modelo en la población general.

-   [Tasa de No Información (No Information Rate)]{.underline}: Es el mayor de las proporciones de las clases de referencia, que en este caso es 50%. Este valor se utiliza para comparar la precisión del modelo; una precisión significativamente mayor que la tasa de no información indica un modelo útil.

-   [P-value de la Precisión Mayor que la Tasa de No Información]{.underline}: Menor que 2.2e-16, lo que sugiere que el modelo es significativamente mejor que una conjetura al azar.

-   [Kappa]{.underline}: De 0.2345, reflejando una concordancia débil a moderada más allá de la coincidencia por casualidad.

-   [Prueba de McNemar Valor-P]{.underline}: Menor que 2.2e-16, lo que indica una diferencia significativa entre los falsos positivos y los falsos negativos.

-   [Sensibilidad]{.underline}: El 42.14% de los individuos diabéticos reales fueron correctamente identificados, lo que sugiere una capacidad moderadamente baja del modelo para detectar la clase "Diabetic".

-   [Especificidad]{.underline}: El 81.31% de los individuos saludables reales fueron correctamente identificados, indicando una alta capacidad del modelo para detectar la clase "Healthy".

-   [Valor Predictivo Positivo]{.underline} : El 69.28% de los individuos clasificados como diabéticos eran realmente diabéticos.

-   [Valor Predictivo Negativo]{.underline}: El 58.43% de los individuos clasificados como saludables eran realmente saludables.

-   [Prevalencia de la Clase "Diabetic"]{.underline}: Se asumió un 50%, lo que indica que las clases están balanceadas en el conjunto de datos utilizado para esta matriz de confusión.

-   [Tasa de Detección para "Diabetic"]{.underline}: El 40.66% del total de individuos fueron correctamente identificados como saludables.

-   [Prevalencia de Detección para "Diabetic"]{.underline}: El 30% del total de predicciones fueron para la clase 'Diabetic'.
